...
(`io.github.adrian0511:prompt-link`) que actúa como cliente de IA generativa a
través de OpenRouter, con autoconfiguración de Spring Boot, cliente Feign
aislado, errores tipados y streaming de tokens en WebFlux. Es la librería que
mueve este mismo chat.

**Portfolio** (esta web) — Backend Spring Boot con WebFlux que sirve un frontend
React compilado y consume la API de GitHub. Incluye flujo CSRF por sesión,
caché en memoria, política de caché por ruta y fuentes autoalojadas.
